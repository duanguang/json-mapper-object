...
function mapFromJson(decoratorMetadata, instance, json, key) {
    ...
    if (value === null || value === undefined) {
        if (decoratorMetadata.clazz && (typeof json === 'undefined' ? 'undefined' : (0, _typeof3.default)(json)) === 'object') {
...
function serialize(instance) {
    ...
    (0, _keys2.default)(instance).forEach(function (key) {
        ...
        if (metadata && !metadata.name && metadata.clazz) {
            obj = (0, _assign2.default)(obj, serializeProperty(metadata, instance[key]));
        } else {
